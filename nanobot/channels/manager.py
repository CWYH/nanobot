...
class ChannelManager:
    ...
    def __init__(self, config: Config, bus: MessageBus, data_dir: Path | None = None):
        self.config = config
        self.bus = bus
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.mochat.enabled:
            try:
                ...
                self.channels["mochat"] = MochatChannel(
                    self.config.channels.mochat, self.bus, data_dir=self.data_dir
                )
        ...
        if self.config.channels.teams.enabled:
            try:
                ...
                self.channels["teams"] = TeamsChannel(self.config.channels.teams, self.bus)
